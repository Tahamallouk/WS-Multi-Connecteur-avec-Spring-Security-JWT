...
public class CustomerRestController {
    ...
    CustomerDto customerByIdentity(@PathVariable("identity") String identity) {
    ...
    public ResponseEntity<UpdateCustomerResponse> updateCustomer(@PathVariable String identityRef,
                                                                 @RequestBody @Valid UpdateCustomerRequest dto) {
